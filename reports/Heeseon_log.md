...
## 📋 목차
1. [데이터 기본 현황](#1-데이터-기본-현황)
2. [중복 데이터 처리](#2-중복-데이터-처리)
3. [이상치 처리 — High_Velocity == 0](#3-이상치-처리)
4. [파생 변수 생성](#4-파생-변수-생성)
5. [클래스 불균형 확인](#5-클래스-불균형-확인)
6. [중복 제거 전후 불량률 비교](#6-중복-제거-전후-불량률-비교)
7. [다음 단계](#7-다음-단계)
